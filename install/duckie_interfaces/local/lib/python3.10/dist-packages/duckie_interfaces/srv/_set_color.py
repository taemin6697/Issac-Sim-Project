...
class Metaclass_SetColor_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('duckie_interfaces')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_SetColor(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'duckie_interfaces.srv.SetColor')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from duckie_interfaces.srv import _set_color
...
class SetColor(metaclass=Metaclass_SetColor):
    from duckie_interfaces.srv._set_color import SetColor_Request as Request
    from duckie_interfaces.srv._set_color import SetColor_Response as Response
