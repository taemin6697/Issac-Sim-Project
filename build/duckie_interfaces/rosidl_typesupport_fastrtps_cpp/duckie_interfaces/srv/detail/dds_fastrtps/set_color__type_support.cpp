...
#include "duckie_interfaces/srv/detail/set_color__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = duckie_interfaces::srv::SetColor_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const duckie_interfaces::srv::SetColor_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<duckie_interfaces::srv::SetColor_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_duckie_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<duckie_interfaces::srv::SetColor_Request>()
{
  return &duckie_interfaces::srv::typesupport_fastrtps_cpp::_SetColor_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = duckie_interfaces::srv::SetColor_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const duckie_interfaces::srv::SetColor_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<duckie_interfaces::srv::SetColor_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &duckie_interfaces::srv::typesupport_fastrtps_cpp::_SetColor_Response__handle;
}
...
{
  return &duckie_interfaces::srv::typesupport_fastrtps_cpp::_SetColor__handle;
}
