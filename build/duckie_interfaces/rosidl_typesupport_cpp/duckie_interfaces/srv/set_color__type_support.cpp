...
static const _SetColor_Request_type_support_symbol_names_t _SetColor_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, duckie_interfaces, srv, SetColor_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, duckie_interfaces, srv, SetColor_Request)),
  }
};
...
get_message_type_support_handle<duckie_interfaces::srv::SetColor_Request>()
{
  return &::duckie_interfaces::srv::rosidl_typesupport_cpp::SetColor_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, duckie_interfaces, srv, SetColor_Request)() {
  return get_message_type_support_handle<duckie_interfaces::srv::SetColor_Request>();
}
...
static const _SetColor_Response_type_support_symbol_names_t _SetColor_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, duckie_interfaces, srv, SetColor_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, duckie_interfaces, srv, SetColor_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<duckie_interfaces::srv::SetColor_Response>()
{
  return &::duckie_interfaces::srv::rosidl_typesupport_cpp::SetColor_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, duckie_interfaces, srv, SetColor_Response)() {
  return get_message_type_support_handle<duckie_interfaces::srv::SetColor_Response>();
}
...
static const _SetColor_type_support_symbol_names_t _SetColor_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, duckie_interfaces, srv, SetColor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, duckie_interfaces, srv, SetColor)),
  }
};
...
get_service_type_support_handle<duckie_interfaces::srv::SetColor>()
{
  return &::duckie_interfaces::srv::rosidl_typesupport_cpp::SetColor_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, duckie_interfaces, srv, SetColor)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<duckie_interfaces::srv::SetColor>();
}
