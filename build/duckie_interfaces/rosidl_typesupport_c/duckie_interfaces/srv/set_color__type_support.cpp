...
static const _SetColor_Request_type_support_symbol_names_t _SetColor_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, duckie_interfaces, srv, SetColor_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, duckie_interfaces, srv, SetColor_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, duckie_interfaces, srv, SetColor_Request)() {
  return &::duckie_interfaces::srv::rosidl_typesupport_c::SetColor_Request_message_type_support_handle;
}
...
static const _SetColor_Response_type_support_symbol_names_t _SetColor_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, duckie_interfaces, srv, SetColor_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, duckie_interfaces, srv, SetColor_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, duckie_interfaces, srv, SetColor_Response)() {
  return &::duckie_interfaces::srv::rosidl_typesupport_c::SetColor_Response_message_type_support_handle;
}
...
static const _SetColor_type_support_symbol_names_t _SetColor_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, duckie_interfaces, srv, SetColor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, duckie_interfaces, srv, SetColor)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, duckie_interfaces, srv, SetColor)() {
  return &::duckie_interfaces::srv::rosidl_typesupport_c::SetColor_service_type_support_handle;
}
